        ...
        <div className="section__item">
            <div className="section__item__components" onClick={() => handleClick()}>
                <div className="section__item__components__image">
                    <img className="section__item__components__image__self" src={product.img} alt={"sad"}/>
                </div>
            ...
            <div className="section__item__components__basket"><BsBasket2Fill onClick={() => handleClickBasket()}/></div>
        </div>
    )
}