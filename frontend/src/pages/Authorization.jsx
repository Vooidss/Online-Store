...
export default function Authorization({active,setActive,setAuthentication}) {
            ...
            <div className={active ? activeLink : defaultLink} onClick={() => setActive(false)}>
                <div className="mainWindow__authenticationWindow" onClick={e => e.stopPropagation()}>
                    ...
                    <div className="mainWindow__authenticationWindow__inputs">
                        ...
                        <a className={(isError) ? 'mainWindow__authenticationWindow__error active' : 'mainWindow__authenticationWindow__error'}>Неверный
                            логин или пароль</a>
                    </div>
                    <button
                        className="mainWindow__authenticationWindow__button"
                        onClick={authentication}>Войти
                    </button>
                </div>
            </div>
        )
